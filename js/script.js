...
$(document).ready(function () {
    ...
    if ($(window).width() < 768) {
        ...
        $(".pet.about .about_us .image .an_image, .about.second .about_us .image .an_image").removeClass("an_image_vt_ps_middle");
        $(".pet.about .about_us .image .an_image, .about.second .about_us .image .an_image").addClass("an_image_vt_ps_bottom");
    ...
    if ($('.counter-box').length) {
        ...
        $('.count-box').appear(function () {
            ...
            var $t = $(this),
                n = $t.find(".counting-value").attr("data-stop"),
                r = parseInt($t.find(".counting-value").attr("data-speed"), 10);

            if (!$t.hasClass("counted")) {
                $t.addClass("counted");
                $({
                    countNum: $t.find(".counting-value").text()
                }).animate({
                    countNum: n
                }, {
                    duration: r,
                    easing: "linear",
                    step: function () {
                        $t.find(".counting-value").text(Math.floor(this.countNum));
                    },
                    complete: function () {
                        $t.find(".counting-value").text(this.countNum);
                    }
                });
            }
